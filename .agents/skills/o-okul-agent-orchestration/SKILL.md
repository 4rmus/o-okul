...
3. Keep legacy `max_threads = 3`; it limits subagents and excludes the main agent, so the main agent and at most three subagents may participate concurrently.
