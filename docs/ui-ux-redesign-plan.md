...
- Bu path/slug patch'i commit/push edilir; GitHub staging workflow'u `STAGING_DEPLOY_DIR=/root/o-okul` ile aynı sözleşmeyi beklemeden deploy dispatch yapılmaz.
