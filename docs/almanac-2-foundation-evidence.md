...
prosesinde okunur; bilinmeyen anahtar veya bozuk kayıt başlangıçta fail eder. Kayıtlar `tenantId`,
zorunlu `startsAt`/`expiresAt` ve PII içermeyen `reference` taşır, en fazla 90 gün geçerlidir. Client
