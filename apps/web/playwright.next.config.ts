...
const webServerCommand = measurementMode
  ? "pnpm --filter @o-okul/shared-types build && pnpm --filter @o-okul/ui build && rm -rf .next && pnpm next:build && exec node node_modules/next/dist/bin/next start --hostname 127.0.0.1 --port 43119"
