...
import {
  campusCreateBodySchema,
  campusUpdateBodySchema,
  type CampusCreateBody,
  type CampusUpdateBody,
...
export class CampusesController {
  ...
  create(@Body(zodBody(campusCreateBodySchema)) body: CampusCreateBody): Promise<CampusRecord> {
    return this.school.createCampus(getRequestContext(), body);
  }

  @Patch(":id")
  @RequireCapability("class:manage")
  update(@Param("id") id: string, @Body(zodBody(campusUpdateBodySchema)) body: CampusUpdateBody): Promise<CampusRecord> {
