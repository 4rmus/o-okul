...
describe("TC kimlik helper", () => {
  it("TC kimliği 11 rakama göre normalize eder", () => {
    expect(normalizeTcIdentity("10000000146")).toBe("10000000146");
    expect(normalizeTcIdentity("10000000145")).toBe("10000000145");
    expect(isValidTcIdentity("1000000014")).toBe(false);
    expect(() => normalizeTcIdentity("1000000014")).toThrow("STUDENT_NATIONAL_ID_INVALID");
  });
