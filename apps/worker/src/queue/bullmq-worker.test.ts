  ...
  return {
    ...
    snapshotData: {
      ...
      students: [{
        ...
        className: "8-A",
        resultKey: "result-a",
        total: { correct: 1, wrong: 0, blank: 0, net: 1, questionCount: 1, rawScore: 1, standardScore: 1, successRate: 100 },
        branches: [{ branch: "Matematik", correct: 1, wrong: 0, blank: 0, net: 1, questionCount: 1, successRate: 100 }],
        questions: [{ questionNo: 1, branch: "Matematik", answer: "A", correctAnswer: "A", status: "CORRECT" }],
        statistics: {
          standardScore: 50,
