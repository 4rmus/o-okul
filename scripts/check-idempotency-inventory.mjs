...
const inventory = [
  ...
  entry("teacher.import.commit", "POST", "/api/v1/teachers/imports", "covered", "apps/api/src/school/teachers.controller.ts", "apps/api/src/school/teacher-import.service.ts", "apps/api/src/school/school.e2e.test.ts", ["@Post(\"imports\")", "@Headers(\"idempotency-key\")"], ["teacher-import-idempotency-a"]),
];
