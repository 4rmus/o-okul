...
const inventory = [
  ...
  entry("portal-support-ticket.student-comment.create", "POST", "/api/v1/me/student/support-tickets/{ticketId}/comments", "covered", "apps/api/src/me/me.controller.ts", "apps/api/src/support-ticket/support-ticket.service.ts", "apps/api/src/support-ticket/support-ticket.e2e.test.ts", ["@Post(\"student/support-tickets/:ticketId/comments\")", "@Headers(\"idempotency-key\")"], ["student-comment-"]),
  entry("portal-support-ticket.teacher-comment.create", "POST", "/api/v1/me/teacher/support-tickets/{ticketId}/comments", "covered", "apps/api/src/me/me.controller.ts", "apps/api/src/support-ticket/support-ticket.service.ts", "apps/api/src/support-ticket/support-ticket.e2e.test.ts", ["@Post(\"teacher/support-tickets/:ticketId/comments\")", "@Headers(\"idempotency-key\")"], ["teacher-comment-"]),
