...
requireTokens("apps/web/e2e-next/a11y-next.spec.ts", [
  ...
  "shell komut paleti kritik axe ihlali olmadan klavye akışını korur",
  "mobil ana menü kritik axe ihlali olmadan açılıp kapanır",
...
requireTokens("apps/web/e2e-next/student-guardian-portal-contract-next.spec.ts", [
  ...
  "{ height: 844, width: 390 }",
  "{ height: 1024, width: 768 }",
  'page.goto(options.mode === "role-preview" ? "/ogrenci?rolePreview=1" : "/ogrenci")',
  'page.goto(options.mode === "role-preview" ? "/veli?rolePreview=1" : "/veli")',
