...
requireTokens("apps/web/e2e-next/a11y-next.spec.ts", [
  ...
  'getByRole("region", { exact: true, name: "Kurum başarı görünümü" })',
  'getByRole("group", { name: "Kurum başarı görünümü metrikleri" })',
  'dashboardSummaryMetrics).toHaveClass(/uh-metric-grid/)',
  'dashboardSummaryMetrics.locator(".uh-metric-card")).toHaveCount(4)',
  'getByRole("region", { exact: true, name: "Bugün ilgilenmeniz gerekenler" })',
...
requireTokens("apps/web/e2e-next/list-url-state-next.spec.ts", [
  "mevcut kullanıcı listesini salt okunur tutup çalışan yönetimine yönlendirir",
  ...
  'getByRole("region", { exact: true, name: "Veli kayıt özeti" })',
  'getByRole("region", { exact: true, name: "Öğretmen operasyon özeti" })',
  'getByRole("region", { exact: true, name: "Akademik yıl özeti" })',
  'getByRole("region", { exact: true, name: "Akademik dönem özeti" })',
  ...
  'getByRole("region", { exact: true, name: "Şablon özeti" })',
  "Şablon özeti önerilen işlemler",
  'getByLabel("Aktarım şablonları").getByRole("link", { name: "Öğretmen XLSX şablonu" })',
  'getByLabel("Aktarım şablonları").getByRole("link", { name: "Öğrenci XLSX şablonu" })',
  'getByLabel("Aktarım şablonları").getByRole("link", { name: "Veli XLSX şablonu" })).toHaveCount(0)',
  ...
  "Materyal operasyon özeti önerilen işlemler",
  ...
  "Etüt operasyon özeti önerilen işlemler",
  "Ders programı operasyon özeti önerilen işlemler",
  "Kazanım operasyon özeti önerilen işlemler",
  ...
  'getByRole("table", { name: "Veli kayıt listesi" })',
  'getByRole("table", { name: "Öğretmen operasyon listesi" })',
  'getByRole("link", { name: "Ada öğrenci özeti" })',
  "Branş kapsamı",
  "Atama bağlamı",
  ...
  "Ödeme planları özeti önerilen işlemler",
  "Destek bildirimleri özeti önerilen işlemler",
...
requireTokens("apps/web/e2e-next/data-table-mobile-contract-next.spec.ts", [
  ...
  "destek öncelik tablosu mobilde operasyon sözleşmesini korur",
  "Destek bildirimleri özeti önerilen işlemler",
  ...
  'examDialog.locator(".uh-field")).toHaveCount(6)',
  ...
  'getByRole("table", { name: "Destek öncelik listesi" })',
  ...
  'getByRole("region", { exact: true, name: "Destek bildirimleri özeti" })',
  ...
  'getByRole("region", { exact: true, name: "SMS alıcı önizleme" })',
...
requireTokens("apps/web/e2e-next/governance-evidence-contract-next.spec.ts", [
  ...
  "KVKK operasyon özeti önerilen işlemler",
  'getByRole("region", { name: "KVKK yönetimi" }).getByRole("table", { name: "KVKK kişisel bilgi temizleme kayıtları" })',
  'expect(kvkkTable).toContainText("Öğrenci kaydı 1")',
  'getByRole("button", { name: "Öğrenci kaydı 1 kişisel bilgileri temizle" })',
  'getByRole("dialog", { name: "Kişisel bilgileri temizlemeyi onayla" })',
  ...
  "Yayın hazırlığı özeti önerilen işlemler",
  ...
  'getByRole("table", { name: "Yedekleme ve geri yükleme işleri" })',
  'getByRole("table", { name: "Yedekleme ve geri yükleme kanıtları" })',
  'getByRole("table", { name: "Geri yükleme tatbikatı rapor alanları" })',
  'getByRole("table", { name: "Kritik geri yükleme tabloları" })',
  "s3://<redacted>",
  "file://<redacted>",
  ...
  'Kanıt kapsamı: Bu ekrandaki bilgi',
  'Kanıt kapsamı: Deneme/canlı ortam',
  'Kanıt kapsamı: Canlı kanıt',
  "expectEvidenceTiers",
  'data-evidence-tier="${tier}"',
  'Kanıt kapsamı: Ekran güvenliği',
  'Kanıt kapsamı: Bağlı sistem',
  "Yayın kararı için yeterli değil",
...
requireNoTokens("apps/web/e2e-next/governance-evidence-contract-next.spec.ts", [
  ...
  "saveScreenshot",
  "toHaveScreenshot",
  'getByRole("button", { name: "Ada kişisel bilgileri temizle" })',
  "Anonim Ogrenci",
]);

requireTokens("apps/web/e2e-next/role-preview-contract-next.spec.ts", [
  "Rol önizleme UI sözleşmesi",
  "kişisel ekran kartları PII göstermeden kapsam ve route sözleşmesini korur",
  ...
  'getByLabel("Kişisel ekran kartları")',
  ...
  "Önizleme güvenlik özeti önerilen işlemler",
  'getByRole("table", { name: "Rolün görebileceği alanlar" })',
  'getByRole("table", { name: "Öğretmen ekranı görülebilen bilgiler" })',
  'getByRole("table", { name: "Öğrenci ekranı görülebilen bilgiler" })',
  'getByRole("table", { name: "Mevcut veli ekranı görülebilen bilgiler" })',
...
requireTokens("apps/web/e2e-next/kvkk-privacy-next.spec.ts", [
  ...
  "Ad, soyad, telefon",
  "Temiz",
  "Öğrenci kaydı 1 kişisel bilgileri temizle",
...
requireNoTokens("apps/web/e2e-next/kvkk-privacy-next.spec.ts", [
  ...
  'getByLabel("Ada kişisel bilgileri temizle")',
]);
...
requireTokens("apps/web/e2e-next/setup-wizard-contract-next.spec.ts", [
  ...
  'getByLabel("Otomatik seçilen dersler")',
  ...
  'getByRole("group", { name: "Veli veri girişi" })',
  'getByRole("link", { name: "Öğretmen XLSX şablonu" })',
  'getByRole("link", { name: "Öğrenci XLSX şablonu" })',
  'getByRole("link", { name: "Kazanım XLSX şablonu" })',
  'getByRole("link", { name: "Veli XLSX şablonu" })',
  "/templates/ogretmen-aktarim-sablonu.xlsx",
  "/templates/ogrenci-aktarim-sablonu.xlsx",
  "/templates/kazanim-aktarim-sablonu.xlsx",
  'getByLabel("Kazanım aktarım dosyası (opsiyonel)")',
  'getByLabel("Kazanım aktarım güven durumu")',
  "/learning-outcomes/imports/dry-run",
  "/learning-outcomes/imports",
  "1 kazanım",
  "toHaveCount(0)",
  ...
  "Öğrenci aktarım dosyası zorunludur.",
  "1 öğrenci ve dosyadaki veli bağlantıları işlendi",
  "setup-student-guardian-link-summary",
  "ASSISTANT_ADMIN",
  "assistant rolünde kurulum yüzeyini açar",
  "toHaveURL(/\\/kurum\\/kurulum$/)",
  'getByLabel("Kurulum formu")).toBeVisible()',
  'getByLabel("Öğretmen aktarım dosyası")).toBeVisible()',
  'getByLabel("Öğrenci aktarım dosyası")).toBeVisible()',
  'getByLabel("Veli aktarım dosyası")).toHaveCount(0)',
  'getByRole("link", { name: /Yeni dönem açılışı|Kurulum/ }).first()).toBeVisible()',
...
requireNoTokens("apps/web/e2e-next/setup-wizard-contract-next.spec.ts", [
  ...
  "saveScreenshot",
  "toHaveScreenshot",
  "/templates/veli-aktarim-sablonu.xlsx",
  "/guardians/imports/dry-run",
  "/guardians/imports",
  "1 veli eklendi",
]);
...
requireNoTokens("apps/web/app/(app)/kurum/_shared/import-template-panel.tsx", [
  "Veli XLSX şablonu",
  "/templates/veli-aktarim-sablonu.xlsx",
]);
...
requireTokens("apps/web/e2e-next/optik-workspace-contract-next.spec.ts", [
  ...
  'getByRole("tab", { name: "3. Eşleşmeyen satırlar" })',
  'getByRole("tab", { name: /Cevap anahtarı/ })).toHaveCount(0)',
  "rawEvaluationJobId",
  'getByRole("status").filter({ hasText: "1/1 kayıt için analiz başlatıldı." })',
  ...
  "studentSearchRequests",
  "hostileOptikReferences",
  "rawImportFileName",
  'selectedFormSummary).toHaveClass(/uh-info-grid/)',
  'selectedFormSummary.locator(".uh-info-item")).toHaveCount(2)',
  ...
  'toContainText("Dosya kaydı: maskeli")',
  'toContainText("Hazırlama işlemi: maskeli")',
  'toContainText("Dosya izi: maskeli")',
  "not.toContainText(value)",
  'getByRole("region", { name: "Rapor hazırlama durumu" })',
...
requireTokens("apps/web/app/(app)/kurum/optik/parser-config-page.tsx", [
  ...
  "TYT 120 / AYT 160",
  "OPTİK 840 — LGS",
  "Gerçek dosya örneği bekleniyor",
...
requireTokens("apps/web/e2e-next/portal-report-panel-next.spec.ts", [
  ...
  "Karne rapor bilgileri",
  "Karne başarı özeti",
  'karneSummary.getByRole("region", { exact: true, name: "Karne rapor bilgileri" })',
  'getByRole("group", { name: "Karne rapor ölçüleri" })',
  ...
  'karneSuccessSummary.locator(".uh-metric-card")).toHaveCount(6)',
...
requireTokens("apps/web/e2e-next/student-guardian-portal-contract-next.spec.ts", [
  ...
  'getByRole("link", { name: /Son sınavı incele: %81,7/ })',
  ...
  'relationshipInfo.locator(".uh-info-item")).toHaveCount(3)',
  ...
  'toHaveText(["Veli", "İzinler"])',
  'toHaveText(["Sınıf", "Organizasyon", "Dönem", "Başlangıç", "Durum", "Neden"])',
  "Bilinmeyen veli",
  "Sınıf bilgisi yok",
  "Dönem bilgisi yok",
  "guardian-missing",
...
requireTokens("apps/web/e2e-next/report-workspace-contract-next.spec.ts", [
  ...
  'getByRole("tab", { name: "Genel Bakış" })',
  'getByRole("tab", { name: "Öğrenciler" })',
  'getByRole("tab", { name: "Karne" })',
  ...
  "Excel/PDF hazır",
  "1 sonuç girdisi",
  "workflowStrip).toHaveClass(/next-report-status-surface/)",
  'workflowStrip.locator(".next-report-status-pills > span")).toHaveCount(4)',
  'workflowStrip.locator(".next-report-meta-details")',
  "Karne rapor bilgileri",
  "Karne başarı özeti",
  'karneSheet.getByRole("region", { exact: true, name: "Karne rapor bilgileri" })',
  'getByRole("group", { name: "Karne rapor ölçüleri" })',
  "karneContextMetrics).toHaveClass(/uh-info-grid/)",
  'karneContextMetrics.locator(".uh-info-item")).toHaveCount(7)',
  'karneSheet.getByRole("region", { exact: true, name: "Karne başarı özeti" })',
  "karneSummary).toHaveClass(/uh-metric-grid/)",
  'karneSummary.locator(".uh-metric-card")).toHaveCount(6)',
  'getByRole("row", { name: /GELİŞİM/ })).toContainText("-%3,3")',
  'getByRole("heading", { name: "Öğrenci gelişim grafiği" })).toBeVisible()',
...
requireTokens("apps/web/app/(app)/kurum/_shared/import-template-panel.tsx", [
  "const importTemplates",
  'aria-label="Aktarım şablonları"',
  "/templates/ogretmen-aktarim-sablonu.xlsx",
  "/templates/ogrenci-aktarim-sablonu.xlsx",
  "/templates/kazanim-aktarim-sablonu.xlsx",
...
requireTokens("apps/web/app/(app)/kurum/kurulum/setup-wizard.tsx", [
  "Button, Field, Input, MetricCard, MetricGrid, Panel, SegmentedControl, Select, StatusBadge, TabButton, Tabs",
  "SetupUploadStatus",
  ...
  'aria-label="Otomatik seçilen dersler"',
  "Sınıfa göre otomatik seçilen dersler",
...
requireTokens("apps/web/app/(app)/kurum/ogrenciler/student-detail-page.tsx", [
  ...
  "Finans görünürlüğü:",
  "includeFinance ?",
  "İzinler veli bağlantısında kontrollü gösterilir",
...
requireTokens("apps/web/e2e-next/student-relationship-flow-next.spec.ts", [
  'getByRole("region", { exact: true, name: "Öğrenci detay özeti" })',
  "Öğrenci detay özeti önerilen işlemler",
...
requireTokens("apps/web/app/(app)/kurum/veliler/guardian-detail-page.tsx", [
  ...
  "Hassas izinler varsayılan kapalıdır",
...
requireTokens("apps/web/e2e-next/guardian-privacy-next.spec.ts", [
  'getByRole("region", { exact: true, name: "Veli detay özeti" })',
...
requireTokens("apps/web/app/(app)/kurum/akademik-takvim/academic-calendar-page.tsx", [
  ...
  "Yıl listesi seçimi korunur",
  "Dönem listesi seçimi korunur",
  "Aktif yıl kontrolü",
...
requireTokens("apps/web/app/(app)/kurum/kazanimlar/learning-outcomes-page.tsx", [
  ...
  "/templates/kazanim-aktarim-sablonu.xlsx",
  "Kazanım XLSX şablonu",
  "dryRunLearningOutcomeImport",
  "commitLearningOutcomeImport",
  "`${apiBaseUrl}/learning-outcomes/imports/dry-run`",
  "`${apiBaseUrl}/learning-outcomes/imports`",
...
requireTokens("apps/web/app/(app)/kurum/kullanicilar/users-page.tsx", [
  ...
  "Bu liste yalnız mevcut hesapları gösterir.",
  'mobilePriority: "primary"',
  'mobilePriority: "secondary"',
...
requireTokens("apps/web/app/(app)/kurum/siniflar/class-detail-page.tsx", [
  ...
  "reportSuccessRate",
  "reportQuestionCount",
  "student.displayName ?? studentNameLabel",
  "student.studentNo",
  "Rapor alınamadı",
]);
...
requireTokens("apps/web/app/(app)/kurum/rol-onizleme/role-preview-page.tsx", [
  ...
  'aria-label="Kişisel ekran kartları"',
...
requireTokens("apps/web/app/(app)/kurum/_shared/sms-delivery-report-panel.tsx", [
  ...
  "Gönderim durumu",
  "Gönderim için kabul edilen",
  "Müdahale gerekli",
  "Hesaplanan mesaj parçası",
...
requireTokens("apps/web/app/(app)/kurum/kvkk/kvkk-page.tsx", [
  ...
  "Sistem kaydı esas",
  "Onay zorunlu",
  "Telefon veya T.C. kimlik numarası gibi değerler yerine veri kategorisi gösterilir.",
]);
...
requireTokens("apps/web/e2e-next/governance-evidence-contract-next.spec.ts", [
  ...
  "Güvenlik durumu özeti önerilen işlemler",
...
requireTokens("apps/web/app/(app)/kurum/denetim/audit-logs-page.tsx", [
  ...
  "Bilgiler maskeli",
  "Kaynak: sistem kaydı",
  "Kişisel bilgiler açık gösterilmez",
]);
...
requireTokens("apps/web/app/(app)/kurum/yedek-restore/backup-restore-page.tsx", [
  ...
  "maskTargetReference",
  "maskJobReference",
  "Kurum verisi dışa aktarımı",
  "Kurum verisini indir",
  "sunucu tarafındaki geri yükleme kanıtının yerine geçmez",
  "Yayın doğrulaması ayrıca yapılır",
  "backup:restore:smoke",
  "backup:offsite:smoke",
  "wal:archive:smoke",
...
requireTokens("apps/web/app/(app)/kurum/optik/parser-config-page.tsx", [
  ...
  "Cevap anahtarı hazır sınavı seç, optik düzeni belirle ve dosya yüklemesini tek akışta kontrol et.",
  "Cevap anahtarı sınav oluşturulurken hazırlanır; bu ekran format, optik yükleme ve eşleşmeyen satır çözümünü yürütür.",
  ...
  "Sınavınıza uygun optik düzeni seçin. Seçiminiz yükleme adımında kullanılacak.",
  ...
  "Yüklenen dosyanın kontrolü ve analiz durumu.",
  ...
  "formatEvidenceSafeReference(rawImport.rawImport.id, \"Dosya kaydı\")",
  "formatEvidenceSafeReference(rawImport.parseJob.jobId, \"Hazırlama işlemi\")",
  "formatEvidenceSafeReference(rawImport.rawImport.sha256, \"Dosya izi\")",
  "formatEvidenceSafeReference(record.evaluationJob.jobId, \"Hazırlama işlemi\")",
  "readOpticalTab",
  ...
  "Destek kayıtları ekran görüntülerinde açık gösterilmez.",
  'type="password"',
]);
...
requireTokens("apps/web/app/(app)/kurum/raporlar/reports-page.tsx", [
  ...
  "Önce sınavı seçin; kapsam filtreleri yalnız gerektiğinde açılır.",
  'className="next-report-control-row"',
  'className="next-report-filter-details"',
  ...
  'role="alert"',
  'role="status"',
  "Üstteki kontrol alanından sınavı ve kapsamı seçerek raporu açın veya hazırlayın.",
  '<Field label="Puan türü">',
  "Eski hesaplama",
  "Standart sapma kullanılmadan hesaplanan deneme puanıdır.",
  "Kampüs bilgisi yok",
  "Sınıf bilgisi yok",
  "Ders bilgisi yok",
  'className="next-report-status-surface"',
  'className="next-report-status-pills"',
  'className="next-report-meta-details"',
  "<summary>Rapor ayrıntıları</summary>",
  "Excel/PDF hazır",
  "Hazır rapor sürümü gerekli",
  'className="next-report-summary-hero"',
  'aria-label="Rapor özeti"',
  'className="next-report-summary-primary"',
  'className="next-report-summary-metrics"',
  'className="next-report-insights"',
  ...
  "formatScoreCourseSummary",
  "next-report-score-detail",
  "next-report-student-cell",
  "next-report-performance-cell",
  "next-report-rank-cell",
...
requireNoTokens("apps/web/app/(app)/kurum/raporlar/reports-page.tsx", [
  ...
  'className="next-report-workflow-strip"',
  ...
  'header: "Dersler"',
  'header: "Başarı %"',
  'header: "Kurum başarı sırası"',
  'header: "Sınıf başarı sırası"',
  'header: "Kurum içi sıra"',
  'header: "Sınıf içi sıra"',
  "?? snapshot.campusId",
...
requireTokens("apps/web/app/(app)/_shared/karne-sheet.tsx", [
  ...
  "KarneContextStrip",
  "KarneSummaryStrip",
  'aria-label="Karne rapor bilgileri"',
  ...
  'label: "Başarı %"',
  'label: "Net"',
  'label: "Kurum başarı sırası"',
  'label: "Sınıf başarı sırası"',
  "<th>DERS NETLERİ</th>",
  "<th>KURUM BAŞARI SIRASI</th>",
  "<th>SINIF BAŞARI SIRASI</th>",
  "formatScoreCourseNets",
  "<th>Başarı %</th>",
  "<th>Soru sayısı</th>",
  "questionStatusTone",
...
requireNoTokens("apps/web/app/(app)/_shared/karne-sheet.tsx", [
  ...
  '<span key={item.label}>',
  '<b>{item.value || "-"}</b>',
  'label: "Kurum içi sıra"',
  'label: "Sınıf içi sıra"',
]);

requireTokens("apps/worker/src/jobs/report-pdf-render-job.ts", [
  "createV2SnapshotPdfHtml",
  '"INSTITUTION_SUMMARY"',
  '"STUDENT_CARDS"',
  'class="karne karne-summary"',
  'class="karne karne-detail"',
  "Öğrenci Karnesi",
  "Kazanım ve Soru Analizi",
  "Öncelikli Kazanım Analizi",
  "Öğrenci Sıralaması",
  ...
  "Başarı %",
  "formatPdfNumber",
  "formatPdfScoreByType",
  "formatPdfScoreCourseNets",
  "formatPdfRankingsByScope",
  "renderPdfBarChart",
  "formatV2StudentScores",
  "selectPdfOutcomeRows",
  "selectPdfQuestionRows",
  '["Tür", "Durum", "Deneme Puanı", "D", "Y", "B", "Net", "Soru", "Başarı %", "Kurum başarı sırası", "Sınıf başarı sırası"]',
  '["Branş", "Başarı %", "Soru", "Net"]',
  '"Kurum başarı sırası"',
  '"Sınıf başarı sırası"',
  "Puan Türü Karşılaştırması",
  "Ders Başarı Grafiği",
  "Ortalama basari",
]);

requireTokens("apps/worker/src/jobs/report-pdf-render-job.test.ts", [
  "schema v2 scoreViews ve tür bazlı sıraları resmî değil uyarısıyla render eder",
  "kurum özeti branş, sınıf ve öğrenci sıralamasını karne sayfaları olmadan render eder",
  "Başarı %",
  "Öğrenci Sıralaması",
  "Branş Karşılaştırması",
  "Sınıf Karşılaştırması",
  "AYT kurum özetinde SAY EA ve SÖZ puanlarını ayrı kolonlarda render eder",
  "Sayısal puanı",
  "EA puanı",
  "Sözel puanı",
  'class="karne karne-(?:summary|detail)"',
...
requireTokens("apps/web/app/(app)/portals/_shared/portal-shell.tsx", [
  ...
  'className="next-portal-action-strip__secondary"',
  ...
  "portalMetricTone",
  "Başarı % ana metrik",
  "Soru sayısıyla birlikte okunur",
  "Finans görünürlüğü izin kapsamına bağlıdır",
...
requireTokens("apps/web/app/(app)/portals/teacher-portal-page.tsx", [
  ...
  "Atandığınız sınıfın tam öğrenci listesini tarih için tek işlemde kaydedin.",
  'caption="Öğretmen günlük yoklama listesi"',
  "entries: attendanceRoster.map",
  "AttendanceDailyUpsertResponse",
  "`${apiBaseUrl}/attendance/daily`",
  'aria-label="Not ekle"',
...
requireTokens("apps/web/app/globals.css", [
  ...
  ".next-portal-action-strip__secondary",
  ".next-portal-action-strip__secondary-item",
...
requireTokens("apps/web/e2e-next/ui-visual-qa-next.spec.ts", [
  ...
  'getByRole("region", { exact: true, name: "Bugün ilgilenmeniz gerekenler" })',
  'attentionRegion.locator(".next-attention-item.uh-action-card")).toHaveCount(3)',
  'getByRole("region", { exact: true, name: "Kurum başarı görünümü" })',
  'getByRole("group", { name: "Kurum başarı görünümü metrikleri" })',
  'dashboardSummaryMetrics).toHaveClass(/uh-metric-grid/)',
  'dashboardSummaryMetrics.locator(".uh-metric-card")).toHaveCount(4)',
  ...
  'guardianProfileInfo.getByText("SMS izni").count()',
  "expect([0, 1]).toContain(smsPermissionCount)",
  'guardianProfileInfo.locator(".uh-info-item")).toHaveCount(smsPermissionCount === 1 ? 6 : 5)',
  'teacherProfileInfo).toHaveClass(/uh-info-grid/)',
  'teacherProfileInfo.locator(".uh-info-item")).toHaveCount(3)',
  'classReportContext).toHaveClass(/uh-info-grid/)',
  'classReportContext.locator(".uh-info-item")).toHaveCount(4)',
  ...
  'studentReportContext.locator(".uh-info-item")).toHaveCount(6)',
  ...
  "Öğrenci sınav özeti",
  "Öğrenci sınav özeti önerilen işlemler",
  ...
  'pathName === "/me/teacher/homework/material-assignments"',
  ...
  "Veli detay özeti",
  "Veli detay özeti önerilen işlemler",
