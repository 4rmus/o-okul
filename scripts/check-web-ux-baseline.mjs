...
requireTokens("apps/web/e2e-next/data-table-mobile-contract-next.spec.ts", [
  ...
  'examDialog.locator(".uh-field")).toHaveCount(2)',
...
requireTokens("apps/web/e2e-next/optik-workspace-contract-next.spec.ts", [
  ...
  'getByRole("tab", { name: "2. Cevap anahtarı" })',
  'getByRole("tab", { name: "3. Optik yükleme" })',
  'getByRole("tab", { name: "4. Eşleşmeyen satırlar" })',
  'getByLabel("Cevap anahtarı Excel import")',
  'getByLabel("Manuel cevap anahtarı")',
  "rawEvaluationJobId",
  "reportGenerationJobId",
  'getByRole("status").filter({ hasText: "90 soru doğrulandı." })',
  'getByRole("status").filter({ hasText: "Excel cevap anahtarı içe aktarıldı." })',
  'getByRole("status").filter({ hasText: "90 manuel soru doğrulandı. B: 90 soru" })',
  'getByRole("status").filter({ hasText: "Manuel cevap anahtarı kaydedildi." })',
  ...
  'getByRole("table", { name: "Cevap anahtarı branş dağılımı" })',
  "Excel cevap anahtarı içe aktarıldı.",
  'not.toContainText("optik-answer-key-v1")',
  "90 manuel soru doğrulandı. B: 90 soru",
  "Manuel cevap anahtarı kaydedildi.",
  "hostileOptikReferences",
  "rawImportFileName",
  'not.toContainText("manual-key-v1")',
...
requireTokens("apps/web/app/(app)/kurum/optik/parser-config-page.tsx", [
  ...
  "Optik iş akışını mevcut sınava bağla veya yeni sınav kaydı oluştur.",
  ...
  'className="next-optical-answer-key-grid"',
  'className="next-optical-answer-key-panel"',
  "Excel cevap anahtarını ön kontrolden geçir ve doğrulanan sürümü içe aktar.",
  "Ön kontrol sonucu, kitapçık varyantları ve branş soru dağılımı.",
  'className="next-optical-answer-key-panel next-optical-answer-key-panel--wide"',
  "Şık dizisini, kitapçık sırasını ve soru bazlı branş/kazanım bağlamını elle düzenle.",
  ...
  "manualAnswerKeyColumns",
  'columns={manualAnswerKeyColumns}',
  "caption=\"Manuel cevap anahtarı grid'i\"",
  "Soru bazlı şık, branş, kazanım ve konu bilgisi.",
  ...
  '<p aria-live="polite" role="status">Excel cevap anahtarı içe aktarıldı.</p>',
  '<p aria-live="polite" role="status">Manuel cevap anahtarı kaydedildi.</p>',
