...
function buildValidEnvFile() {
  ...
  const replacements = new Map([
    ["https://__SET_STAGING_WEB_HOST__", "https://staging.uzmanhocam.com"],
    ["https://__SET_STAGING_API_HOST__", "https://api.staging.uzmanhocam.com"],
    ["__SET_APP_DB_PASSWORD__", "contractAppDbPasswordValue001"],
    ["__SET_MIGRATION_DB_PASSWORD__", "contractMigrationDbPasswordValue001"],
    ["__SET_STAGING_DB_HOST__", "db.staging.uzmanhocam.internal"],
    ...
    ["__SET_STAGING_COOKIE_DOMAIN__", "staging.uzmanhocam.com"],
    ...
    ["__SET_NETGSM_MSG_HEADER__", "UZMANHOCAM"],
    ["https://__SET_NOTIFICATION_ENDPOINT__", "https://notify.staging.uzmanhocam.com/hook"],
    ["__SET_NOTIFICATION_BEARER_TOKEN__", "contractNotificationBearer00000000009"],
    ["__SET_STAGING_EMAIL_TO__", "ops@uzmanhocam.com"],
    ["__SET_STAGING_PUSH_TO__", "push-target-staging-team"],
    ["https://__SET_S3_ENDPOINT__", "https://s3.staging.uzmanhocam.com"],
    ...
    ["https://__SET_SENTRY_DSN__", "https://contractpublickey@sentry.staging.uzmanhocam.com/123"],
    ["s3://__SET_WAL_ARCHIVE_BUCKET__/staging", "s3://uzman-hocam-wal/staging"],
    ["https://__SET_ALERT_WEBHOOK_URL__", "https://alerts.staging.uzmanhocam.com/webhook"],
