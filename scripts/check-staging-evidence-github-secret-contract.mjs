...
function buildValidEnvFile() {
  ...
  const replacements = new Map([
    ...
    ["__SET_DEPLOYMENT_REGION_PROVIDER__", "Limon Cloud"],
    ["__SET_DEPLOYMENT_REGION_REGION__", "tr-istanbul-1"],
    ["__SET_DEPLOYMENT_REGION_EVIDENCE_REFERENCE__", "https://evidence.o-okul.com/provider/limon-cloud-tr-datacenter"],
