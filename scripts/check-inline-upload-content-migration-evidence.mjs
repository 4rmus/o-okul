...
try {
  ...
  fail(["INLINE_UPLOAD_CONTENT_MIGRATION_TARGET file://, http:// veya https:// URL olmali."]);
}
...
async function readJsonTarget(url) {
  ...
  fail(["INLINE_UPLOAD_CONTENT_MIGRATION_TARGET yalniz file://, http:// veya https:// destekler."]);
}
