...
function checkOutboxVerifyWorkflowContract(output) {
  ...
  for (const token of [
    ...
    "DOMAIN CF_DNS_API_TOKEN_FILE LEGACY_TENANT_LOGIN_CUTOFF_AT NOTIFICATION_FROM_EMAIL NOTIFICATION_REPLY_TO_EMAIL NOTIFICATION_SMOKE_EMAIL_TO DATABASE_URL DIRECT_DATABASE_URL DOCKER_DATABASE_URL DOCKER_DIRECT_DATABASE_URL SECRET_DELIVERY_WORKER_DB_PASSWORD SECRET_DELIVERY_OUTBOX_DATABASE_URL DOCKER_SECRET_DELIVERY_OUTBOX_DATABASE_URL REDIS_URL",
